...
export function buildBackupScript(): string {
    return [
        ...
        '  done',
        '',
        '# Se copia TODO, incluido lo que parece regenerable.',
        '#',
        '# Excluir node_modules/.venv recortaba un cuarto de cada copia, pero',
        '# deja la restauración dependiendo de que exista un fichero de',
        '# dependencias — y en la flota hay un entorno de Python de 1,6 GB SIN',
        '# requirements.txt, montado por el propio agente, del que depende su',
        '# biblioteca de documentos. Una copia que sólo sirve si alguien hizo',
        '# los deberes no es una copia. El sistema tiene que ser externo e',
        '# infalible aunque cueste espacio.',
